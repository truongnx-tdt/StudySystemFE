...
export class LaptopService {
  ...
  getProductsByCategory(): Observable<any[]> {
    this.filteredProducts = this.products.filter(product => product.categoryId === 'lap-top');
    return of(this.filteredProducts);
  }


  getProductsByBrand(id: any): Observable<any[]> {
    const filteredProducts = this.products.filter(product => product.brandId.includes(id));
